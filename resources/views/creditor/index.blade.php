...
@section('content')
  ...
  <div ng-controller="CreditorController" ng-cloak>
    <div class="panel panel-default">
      ...
      <!-- List group -->
      <ul class="list-group">
        <li class="list-group-item" ng-repeat="creditor in creditors">
          <div class="row">
	...
	<script type="text/ng-template" id="modalCreditor.html">
		<form id="clientForm">
			<div class="modal-header">
          		<h3 class="modal-title" id="modal-title"><% IsEdit?'Editar':'Nuevo' %> acreedor</h3>
      		</div>
  			<div class="modal-body" id="modal-body">
					<div class="row">
						<div class="form-group col-md-6">
						    <label for="business_name">Acreedor</label>
					    	<input type="text" id="business_name" class="form-control" ng-model="creditor.business_name">
					  	</div>
						<div class="form-group col-md-6">
						    <label for="contact_name">Nombre del contacto</label>
					    	<input type="text" id="contact_name" class="form-control" ng-model="creditor.contact_name">
					  	</div>
					</div>
					<div class="row">
						<div class="form-group col-md-6">
						    <label for="office_phone">Telefono de contacto</label>
					    	<input type="text" id="office_phone" class="form-control" ng-model="creditor.office_phone">
					  	</div>
					  	<div class="form-group col-md-6">
						    <label for="email">Correo</label>
					    	<input type="text" id="email" class="form-control" ng-model="creditor.email"> 
					  	</div> 
					</div>
					<div class="row">
						<div class="form-group col-md-6">
						    <label for="street">Calle</label>
					    	<input type="text" id="street" class="form-control" ng-model="creditor.street">
					  	</div>
					  	<div class="form-group col-md-2">
						    <label for="inner_number">Int</label>
					    	<input type="text" id="inner_number" class="form-control" ng-model="creditor.inner_number">
					  	</div>
					  	<div class="form-group col-md-2">
						    <label for="outdoor_umber">Ext</label>
					    	<input type="text" id="outdoor_umber" class="form-control" ng-model="creditor.outdoor_number">
					  	</div>
					</div>
					<div class="row">
						<div class="form-group col-md-5">
						    <label for="state">Estado</label>
					    	<input type="text" id="state" class="form-control" ng-model="creditor.state">
					  	</div>
					  	<div class="form-group col-md-5">
						    <label for="town">Municipio</label>
					    	<input type="text" id="town" class="form-control" ng-model="creditor.town">
					  	</div>
					  	<div class="form-group col-md-2">
						    <label for="postal_code">CP</label>
					    	<input type="text" id="postal_code" class="form-control" ng-model="creditor.postal_code">
					  	</div>
					</div>
  			</div>
...
@section('scripts')
  <script src="{{ asset('controllers/CreditorController.js') }}"></script>
@endsection